# -*- coding: utf-8 -*-
"""
Created on Mon May 29 10:40:56 2023
...
if rank == 0:
    np.save('Radius0.npy', Radius, allow_pickle=True, fix_imports=True)
   


if rank == 1:
    np.save('Radius1.npy', Radius, allow_pickle=True, fix_imports=True)
